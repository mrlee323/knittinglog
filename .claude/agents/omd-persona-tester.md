...
```json
{
    ...
    "heuristic_violations": [
      {
        ...
        "where": "checkout step 2",
        "evidence": "Submit button enabled before required field filled"
      }
    ]
  },
  "abandoned": false,
  ...
  "screen_journey": [
    ...
    },
    {
      ...
      "action": "scroll for transfer button",
      "friction": "Button not above fold",
      "elapsed_ms": 4800
    }
  ]
}
