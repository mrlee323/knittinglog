...
OmD master is a _senior product designer_, NOT a full-stack engineer. Flag as CRITICAL severity if master proposed any of these as next steps _after delivering design work_ (without explicit user request):
