...
verification_v2:
  ...
  surfaces:
    ...
    - {
        id: method,
        kind: official-method,
        url: "https://linear.app/method",
        inspected: "2026-07-12",
      }
    - {
        id: customers,
        kind: marketing-customer,
  ...
  claims:
    ...
    "tokens.components.customer-card.type":
      &customers_evidence {
        surface_id: customers,
        source_id: customers-live,
        method: live-inspect,
        captured: "2026-07-12",
      }
    ...
    display:
      {
        ...
        lineHeight: 1,
        tracking: -1.056,
        use: "Repeated public section display heading",
      }
    heading:
      {
        size: 24,
        ...
        lineHeight: 1.33,
        tracking: -0.288,
        use: "Public feature and card heading",
      }
    body:
      {
        size: 15,
        ...
        lineHeight: 1.6,
        tracking: -0.165,
        use: "Method and public descriptive body",
      }
    navigation:
      {
        size: 13,
        ...
        lineHeight: 1.5,
        tracking: -0.13,
        use: "Public navigation and compact product-preview labels",
      }
    mono:
      {
        size: 14,
        weight: 400,
        lineHeight: 1.71,
        use: "Embedded public product-preview technical input",
      }
    ...
    primary-action:
      {
        ...
        height: "44px",
        font: "16px / 510",
        states: "default captured; compact 32px variant remains local",
    ...
    secondary-action:
      {
        ...
        height: "44px",
        font: "16px / 510",
        states: "default captured; no universal hover token promoted",
    ...
    nav-trigger:
      {
        ...
        height: "32px",
        font: "13px / 400",
        states: "focus, hover, pressed, expanded, and menu-open observed across current routes",
    ...
    product-menu-item:
      {
        ...
        font: "16px / 400",
        states: "selected, expanded, and menu-open captured in the embedded product preview",
