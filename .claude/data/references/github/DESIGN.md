...
tokens:
    ...
    family:
      {
        ...
        marketing: "Mona Sans, Hubot Sans",
      }
    page-title:
      {
        size: 32,
        weight: 600,
        lineHeight: 1.25,
        use: "Repo/profile name, page title",
      }
    h1:
      {
        size: 24,
        weight: 600,
        lineHeight: 1.25,
        use: "Section titles, settings headers",
      }
    h2:
      {
        size: 20,
    ...
    h3:
      {
        ...
        weight: 600,
        lineHeight: 1.25,
        use: "List group headers, dialog titles",
      }
    body:
      {
        size: 14,
        weight: 400,
        lineHeight: 1.5,
        use: "The GitHub baseline — most UI text",
      }
    body-strong:
      {
        size: 14,
        weight: 600,
        lineHeight: 1.5,
        use: "File names, author names, emphasized labels",
      }
    small:
      {
        size: 12,
        weight: 400,
        lineHeight: 1.4,
        use: "Metadata, timestamps, counts, badges",
      }
    code:
      {
        size: 13,
        weight: 400,
        lineHeight: 1.45,
        use: "Mono — code, SHAs, paths, inline code",
      }
  ...
  components:
    button-primary:
      {
        ...
        hover: "bg #1a7f37",
        active: "bg #187733",
        disabled: "bg #94d3a2 · text 0.8 opacity",
    ...
    button-sizes:
      {
        type: button,
        radius: "6px",
        states: "small 28px / 12px / 0 12px · medium 32px / 14px / 0 16px · large 40px / 14px / 0 20px",
    ...
    text-input:
      {
        ...
        padding: "5px 12px",
        font: "14px / 400",
        focus: "border #0969da + shadow 0 0 0 3px rgba(9,105,218,0.3)",
        states: "error border #cf222e + ring rgba(207,34,46,0.3) + #cf222e help text",
    ...
    checkbox:
      {
        ...
        radius: "3px",
        height: "16px",
        active: "checked #0969da fill + white check glyph",
        focus: "shadow 0 0 0 3px rgba(9,105,218,0.3)",
    ...
    radio:
      {
        ...
        radius: "9999px",
        height: "16px",
        active: "checked #0969da ring + filled #0969da dot",
        focus: "shadow 0 0 0 3px rgba(9,105,218,0.3)",
    ...
    state-label:
      {
        ...
        padding: "4px 12px",
        font: "12px / 500",
        states: "open #1f883d · merged #8250df · closed #cf222e · draft #59636e",
    ...
    action-list:
      {
        ...
        padding: "16px",
        hover: "bg #f6f8fa",
        active: "selected bg #ddf4ff + text #0969da",
    ...
    underline-nav:
      {
        type: tab,
        border: "1px bottom border #d1d9e0",
        fg: "#1f2328",
        font: "14px / 400",
    ...
    segmented-control:
      {
        ...
        border: "1px solid #d1d9e0",
        height: "32px",
        active: "selected white panel + 1px #d1d9e0 + small shadow",
    ...
    breadcrumbs:
      {
        type: tab,
        fg: "#0969da",
        active: "last crumb #1f2328 no-link",
    ...
    pagination:
      {
        ...
        fg: "#0969da",
        radius: "6px",
        active: "current page #0969da fill + #ffffff text",
    ...
    banner:
      {
        ...
        radius: "6px",
        padding: "16px",
        states: "info #ddf4ff · success #dafbe1 · warning #fff8c5 · critical #ffebe9",
    ...
    inline-message:
      {
        type: card,
        fg: "#1a7f37",
        states: "success #1a7f37 · attention #9a6700 · danger #cf222e",
...
- **Marketing display**: GitHub's marketing pages (homepage, Enterprise) use **Mona Sans** and **Hubot Sans**, GitHub's open-source variable typefaces, for hero headlines. Product UI does _not_ use these — it stays on the system stack.
...
2. **Blue is the link, green is the action.** The most-violated GitHub rule by outsiders. Interactive _text_ is blue; the primary _button_ is green. Keep them distinct.
...
_Personas below are fictional archetypes informed by publicly described developer-platform user segments, not individual people._
