    ...
    heading-2:
      {
        ...
        lineHeight: 1.45,
        tracking: -0.01,
        use: "Card/block headings",
      }
    heading-3: { size: 18, weight: 600, lineHeight: 1.56, use: "Sub-sections" }
    subtitle:
      { size: 16, weight: 600, lineHeight: 1.63, use: "List headers, labels" }
    body-large:
      { size: 16, weight: 400, lineHeight: 1.75, use: "Lead paragraphs" }
    body:
      { size: 15, weight: 400, lineHeight: 1.73, use: "Standard reading text" }
    body-small:
      { size: 14, weight: 400, lineHeight: 1.57, use: "Secondary text" }
    caption:
      {
        size: 12,
        weight: 400,
    ...
    amount:
      {
        size: 24,
        weight: 600,
        use: "Invoice & financial figures, tabular nums",
      }
  spacing:
...
_Personas below are fictional archetypes informed by publicly described Japanese B2B SaaS user segments, not individual people._
