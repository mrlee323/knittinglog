...
verification_v2:
  ...
  surfaces:
    - {
        ...
        inspected: "2026-05-15",
      }
    - {
        id: design,
        kind: marketing-product,
        url: "https://www.figma.com/ko-kr/design/",
        inspected: "2026-05-15",
      }
    - {
        id: brand,
    ...
    hero:
      {
        ...
        lineHeight: 1,
        tracking: -1.72,
        use: "Public product-marketing hero",
      }
    section:
      {
        size: 64,
        ...
        lineHeight: 1.1,
        tracking: -0.96,
        use: "Public feature section heading",
      }
    body:
      {
        size: 16,
        ...
        lineHeight: 1.42,
        tracking: -0.14,
        use: "Public body, navigation, and action copy",
      }
    mono-label:
      {
        size: 18,
        ...
        lineHeight: 1.3,
        tracking: 0.54,
        use: "Uppercase technical signpost",
      }
    ...
    indigo-action:
      {
        ...
        height: "49px",
        font: "18px / 480",
        states: "default captured; no hover token promoted",
    ...
    product-segment:
      {
        ...
        height: "43px",
        font: "18px / 480",
        states: "active and inactive variants captured",
    ...
    round-icon:
      {
        ...
        radius: "9999px",
        size: "40px",
        states: "default captured; light and dark surface variants remain local",
