...
verification_v2:
  ...
  sources:
    ...
    - {
        id: product-story,
        kind: official-doc,
        url: "https://ably.team/news/ZS8_IREAACIAr50Y",
        captured: "2026-07-12",
      }
  conflicts: []
  claims:
    ...
    "tokens.colors.seller-body":
      &seller_evidence {
        surface_id: seller,
        source_id: seller-live,
        method: live-inspect,
        captured: "2026-07-12",
      }
    ...
    consumer-label:
      {
        ...
        lineHeight: 1.25,
        tracking: -0.4,
        use: "Current mobile consumer labels",
      }
    consumer-compact:
      {
        size: 12,
        ...
        lineHeight: 1.33,
        tracking: -0.2,
        use: "Current mobile web compact action",
      }
    consumer-meta:
      {
        size: 11,
        weight: 400,
        lineHeight: 1.27,
        use: "Current mobile consumer metadata",
      }
    corporate-display:
      {
        size: 48,
        ...
        lineHeight: 1.33,
        tracking: -0.3,
        use: "Current ABLY Team display heading",
      }
    corporate-section:
      {
        size: 40,
        ...
        lineHeight: 1.4,
        tracking: -0.3,
        use: "Current ABLY Team repeated section heading",
      }
    corporate-card:
      {
        size: 24,
        ...
        lineHeight: 1.33,
        tracking: -0.3,
        use: "Current ABLY Team card heading",
      }
    corporate-body:
      {
        size: 16,
        ...
        lineHeight: 1.5,
        tracking: -0.3,
        use: "Current ABLY Team body and card copy",
      }
    seller-body:
      {
        size: 16,
        weight: 400,
        lineHeight: 1.6,
        use: "Current Seller Square body and navigation text",
      }
    ...
    consumer-open-app:
      {
        ...
        size: "62px x 28px",
        font: "12px / 600",
        states: "default baseline captured; no hover or pressed value promoted",
        use: "Current mobile web compact app-entry action",
      }
    corporate-primary:
      {
        type: button,
        ...
        size: "160px x 56px",
        font: "18px / 600",
        states: "default baseline captured",
    ...
    corporate-card:
      {
        ...
        use: "Current ABLY Team mission or story card",
      }
    seller-primary:
      {
        type: button,
