...
verification_v2:
  ...
  sources:
    ...
    - {
        id: sdk-license,
        kind: license,
        url: "https://docs.upbit.com/kr/page/upbit_developer_sdk_license",
        captured: "2026-07-13",
      }
    - {
        id: roboto-license,
  ...
  claims:
    "tokens.colors.accent":
      &exchange {
        surface_id: exchange,
        source_id: exchange-live,
        method: computed-style,
        captured: "2026-07-13",
      }
    "tokens.colors.accent-deep":
      &home {
    ...
    "tokens.colors.disabled":
      &notice {
        surface_id: support-notice,
        source_id: notice-live,
        method: computed-style,
        captured: "2026-07-13",
      }
    ...
    body:
      {
        ...
        weight: 400,
        lineHeight: "21px",
        use: "Observed public home/list body text",
      }
    dense:
      {
        size: 12,
        weight: 400,
        lineHeight: "normal",
        use: "Observed exchange labels and quick-fill control text",
      }
...
1. **Keep market data local to its surface.** The red `#DD3C44` and blue `#1375EC` observations come from the exchange only. _UI implication:_ do not reuse them as universal marketing, error, or success tokens.
2. **Keep controls compact only where measured.** The retained quick-fill control is 28px high with a 4px radius. _UI implication:_ do not extrapolate that geometry into navigation, forms, or authenticated trading flows.
3. **Keep domains separate.** Marketing home, exchange, support notice, Developer Center, SDK licence, and unobserved authenticated product each have different evidence roles. _UI implication:_ do not combine them into a fictional public design system.
