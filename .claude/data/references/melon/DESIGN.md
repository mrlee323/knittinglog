    ...
    heading:
      {
        size: 14,
        weight: 400,
        use: "Headings/primary text, near-black #1a1a1a",
      }
    control: { size: 13, weight: 400, use: "Interactive controls and inputs" }
    body:
      { size: 12, weight: 400, use: "Dense list rows and metadata, muted gray" }
  spacing:
    ...
    login-button:
      {
        ...
        radius: 0,
        font: "14px/400",
        use: "Primary login, sharp-cornered green",
      }
    search-input:
      {
        type: input,
        ...
        radius: 0,
        font: "13px/400",
        use: "Search field, light-gray text",
      }
    list-row:
      {
        type: listItem,
