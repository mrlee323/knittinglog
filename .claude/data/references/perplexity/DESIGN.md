    ...
    heading:
      {
        ...
        lineHeight: 1.36,
        tracking: -0.01,
        use: "Answer section headers, modal titles",
      }
    subtitle:
      {
        size: 18,
        weight: 600,
        lineHeight: 1.44,
        use: "Source group labels, card headings",
      }
    answer-body:
      {
        size: 16,
        weight: 400,
        lineHeight: 1.63,
        use: "Generated answer text, reading-first leading",
      }
    body:
      {
        size: 15,
        weight: 400,
        lineHeight: 1.60,
        use: "UI descriptions, settings",
      }
    label:
      { size: 14, weight: 500, lineHeight: 1.43, use: "Buttons, tabs, chips" }
    caption:
      {
        size: 13,
        weight: 400,
        lineHeight: 1.38,
        use: "Metadata, source domains, timestamps",
      }
...
3. **Calm over spectacle.** Warm paper, muted teal, quiet grays. The brand earns trust by _not_ shouting in a category that shouts.
