...
tokens:
  ...
  typography:
    ...
    display-hero:
      { size: 48, weight: 400, lineHeight: 1.15, use: "Hero headlines" }
    display-bold:
      {
        size: 48,
        weight: 900,
        lineHeight: 1.50,
        use: "Bold display, Haas Groot Disp",
      }
    section:
      { size: 40, weight: 400, lineHeight: 1.25, use: "Section headings" }
...
Airtable's voice is **product-pragmatic and confidence-quiet** — speaks like an internal tools team explaining what just shipped. Hero messaging: _"Build enterprise-ready AI workflows, apps & agents"_ (homepage 2026-05) — verb-first, capability-list, no hyperbole.
