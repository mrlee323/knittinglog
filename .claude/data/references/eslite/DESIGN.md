...
verification_v2:
  ...
  surfaces:
    ...
    - {
        id: brand-directory,
        kind: public-product-catalog,
        url: "https://www.eslite.com/brand",
        inspected: "2026-07-13",
      }
    - {
        id: expo-brand,
        kind: public-brand-catalog,
        url: "https://www.eslite.com/brand/1098",
        inspected: "2026-07-13",
      }
  sources:
    - {
    ...
    - {
        id: corporate-ideals,
        kind: official-doc,
        url: "https://www.eslitecorp.com/eslite/index.jsp?func_id=fee3ba0215&site_id=eslite_tw",
        captured: "2026-07-14",
      }
    - {
        id: corporate-founder,
        kind: official-doc,
        url: "https://www.eslitecorp.com/eslite/index.jsp?func_id=20f9eec115&site_id=eslite_tw",
        captured: "2026-07-14",
      }
    - {
        id: japan-cultural-bridge,
        kind: official-doc,
        url: "https://meet.eslite.com/tw/tc/article/201909260001",
        captured: "2026-07-14",
      }
    - {
        id: anniversary-35,
        kind: official-doc,
        url: "https://meet.eslite.com/tw/tcr/article/202411040002",
        captured: "2026-07-14",
      }
    - {
        id: expo-platform,
  ...
  claims:
    "tokens.colors.accent":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-selector-backed-computed-style,
        captured: "2026-07-13",
      }
    ...
    "tokens.typography.body.use":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-selector-provenance,
        captured: "2026-07-13",
      }
    "tokens.typography.compact-control.size":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-selector-backed-computed-style,
    ...
    "tokens.typography.compact-control.weight":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-selector-backed-computed-style,
    ...
    "tokens.typography.compact-control.lineHeight":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-selector-backed-computed-style,
    ...
    "tokens.typography.compact-control.use":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-selector-provenance,
    ...
    "tokens.rounded.square":
      {
        surface_id: expo-brand,
        source_id: expo-brand-live,
        method: supplied-selector-backed-computed-style,
        captured: "2026-07-13",
      }
    "tokens.rounded.search-left":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-selector-backed-computed-style,
    ...
    "tokens.components.public-search-input.type":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-selector-provenance,
    ...
    "tokens.components.public-search-input.bg":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-selector-backed-computed-style,
    ...
    "tokens.components.public-search-input.fg":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-selector-backed-computed-style,
    ...
    "tokens.components.public-search-input.border":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-selector-backed-computed-style,
    ...
    "tokens.components.public-search-input.radius":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-selector-backed-computed-style,
    ...
    "tokens.components.public-search-input.padding":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-selector-backed-computed-style,
    ...
    "tokens.components.public-search-input.height":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-selector-backed-computed-style,
    ...
    "tokens.components.public-search-input.font":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-selector-backed-computed-style,
    ...
    "tokens.components.public-search-input.states":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-static-state-samples-without-interaction,
        captured: "2026-07-13",
      }
    "tokens.components.public-search-input.use":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-selector-provenance,
    ...
    "tokens.components.expo-product-card.type":
      {
        surface_id: expo-brand,
        source_id: expo-brand-live,
        method: supplied-selector-provenance-and-classification,
        captured: "2026-07-13",
      }
    "tokens.components.expo-product-card.bg":
      {
        surface_id: expo-brand,
        source_id: expo-brand-live,
        method: supplied-selector-backed-computed-style,
    ...
    "tokens.components.expo-product-card.fg":
      {
        surface_id: expo-brand,
        source_id: expo-brand-live,
        method: supplied-selector-backed-computed-style,
    ...
    "tokens.components.expo-product-card.border":
      {
        surface_id: expo-brand,
        source_id: expo-brand-live,
        method: supplied-selector-backed-computed-style,
    ...
    "tokens.components.expo-product-card.radius":
      {
        surface_id: expo-brand,
        source_id: expo-brand-live,
        method: supplied-selector-backed-computed-style,
    ...
    "tokens.components.expo-product-card.padding":
      {
        surface_id: expo-brand,
        source_id: expo-brand-live,
        method: supplied-selector-backed-computed-style,
    ...
    "tokens.components.expo-product-card.height":
      {
        surface_id: expo-brand,
        source_id: expo-brand-live,
        method: supplied-selector-backed-computed-style,
    ...
    "tokens.components.expo-product-card.font":
      {
        surface_id: expo-brand,
        source_id: expo-brand-live,
        method: supplied-selector-backed-computed-style,
    ...
    "tokens.components.expo-product-card.use":
      {
        surface_id: expo-brand,
        source_id: expo-brand-live,
        method: supplied-selector-provenance,
    ...
    body:
      {
        ...
        weight: 400,
        lineHeight: "24px",
        use: "Repeated public commerce text and product-card samples; the computed Noto Sans TC stack is unresolved and is not a named Eslite UI-family token.",
      }
    compact-control:
      {
        size: 14,
        weight: 500,
        lineHeight: "20px",
        use: "Observed compact public header control only; no complete control type scale is claimed.",
      }
    ...
    public-search-input:
      {
        ...
        states: "default geometry observed on home, brand directory, and expo brand pages; static focus and pressed samples are present, while interactionCount is 0",
    ...
    expo-product-card:
      {
        ...
        height: "270px",
        font: "16px / 400 / 24px / unresolved computed stack",
        use: "Public expo-brand product-card shell; selector surface-3::[data-omd-capture=91].",
      }
...
1. **Make culture encounterable.** Eslite’s official material repeatedly frames value in encounters among reading, art, creative work, and daily life. _UI implication:_ present the object, maker, and cultural context clearly before adding commerce prompts.
2. **Let a place hold multiple practices.** The Japan cultural-bridge feature combines books, events, Taiwanese products, food, and exchange rather than reducing the experience to one category. _UI implication:_ use clear category structure and preserve the distinct purpose of each section.
3. **Treat daily life as a cultural medium.** The expo platform connects humanities and art to ordinary living through design goods and creative perspectives. _UI implication:_ pair editorial description with product information where the source supports that relationship; do not fabricate provenance.
4. **Invite without forcing a conclusion.** The anniversary programme foregrounds dreams, stories, and future-facing encounters. _UI implication:_ use an open, calm CTA and avoid false scarcity or an assumed emotional outcome.
