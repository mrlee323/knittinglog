    ...
    display-hero:
      {
        ...
        lineHeight: 1.06,
        tracking: -0.02,
        use: "Marketing hero headlines (Burgess serif)",
      }
    display-lg:
      {
        size: 52,
        ...
        lineHeight: 1.12,
        tracking: -0.02,
        use: "Section openers, editorial (serif)",
      }
    heading-1:
      {
        size: 40,
    ...
    overline:
      {
        ...
        lineHeight: 1.27,
        tracking: 0.08,
        use: "Eyebrow labels, uppercase section tags",
      }
  spacing:
...
_Personas below are fictional archetypes informed by publicly described corporate-spend-management user segments, not individual people._
