...
verification_v2:
  ...
  sources:
    ...
    - {
        id: brand-story,
        kind: official-doc,
        url: "https://corp.104.com.tw/zh/about104/brand-story/",
        captured: "2026-07-14",
      }
    - {
        id: vision-mission,
        kind: official-doc,
        url: "https://corp.104.com.tw/zh/about104/vision-mission/",
        captured: "2026-07-14",
      }
    - {
        id: innovative-services,
        kind: official-doc,
        url: "https://corp.104.com.tw/zh/sustainability/customer/",
        captured: "2026-07-14",
      }
    - {
        id: be-a-giver,
        kind: official-doc,
        url: "https://corp.104.com.tw/zh/sustainability/community/be-a-giver",
        captured: "2026-07-14",
      }
  conflicts: []
  claims:
    "tokens.colors.primary":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
        captured: "2026-07-13",
      }
    "tokens.colors.primary-deep":
      {
        surface_id: surface-3,
        source_id: company-live,
        method: supplied-live-extract,
        captured: "2026-07-13",
      }
    "tokens.colors.teal":
    ...
    "tokens.typography.label.weight":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.typography.label.lineHeight":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.typography.heading.weight":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.typography.heading.lineHeight":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.search-action.type":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.search-action.bg":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.search-action.fg":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.search-action.radius":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.search-action.padding":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.search-action.font":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.search-action.states":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.search-action.use":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.outline-action.type":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.outline-action.fg":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.outline-action.border":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.outline-action.radius":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.outline-action.padding":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.outline-action.font":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.outline-action.states":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.outline-action.use":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.topic-tab.type":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.topic-tab.fg":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.topic-tab.radius":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.topic-tab.padding":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.topic-tab.font":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.topic-tab.states":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.topic-tab.use":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.active-topic-tab.type":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.active-topic-tab.fg":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.active-topic-tab.radius":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.active-topic-tab.padding":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.active-topic-tab.font":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.active-topic-tab.states":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.active-topic-tab.use":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.company-card.type":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.company-card.bg":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.company-card.border":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.company-card.radius":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.company-card.padding":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.company-card.font":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.company-card.use":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.login-dialog.type":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.login-dialog.bg":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.login-dialog.fg":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.login-dialog.radius":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.login-dialog.shadow":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    "tokens.components.login-dialog.use":
      {
        surface_id: home,
        source_id: home-live,
        method: supplied-live-extract,
    ...
    body:
      {
        ...
        weight: 400,
        lineHeight: 1.43,
        use: "Repeated public home and company-page text; operating-system stack, not a named 104 UI family",
      }
    label:
      {
        size: 14,
        weight: 700,
        lineHeight: 2.14,
        use: "Observed compact action and navigation labels",
      }
    heading:
      {
        size: 20,
        weight: 700,
        lineHeight: 1.4,
        use: "Observed public home section headings only",
      }
    ...
    search-action:
      {
        ...
        states: "default static selector observed; interaction capture recorded 0, so no changed state values are published",
        use: "Observed home navigation-search action",
      }
    outline-action:
      {
        type: button,
        ...
        states: "default static selector observed; interaction capture recorded 0, so no changed state values are published",
        use: "Observed compact public home action",
      }
    topic-tab:
      {
        type: tab,
        ...
        states: "static non-active appearance observed; interaction capture recorded 0, so no transition values are published",
    ...
    active-topic-tab:
      {
        ...
        padding: "8px 16px",
        font: "16px/700/24px operating-system stack",
        states: "static active appearance observed; interaction capture recorded 0, so no transition values are published",
...
1. **Make direction actionable.** A job search or hiring task should clarify the first decision before expanding choices. _UI implication:_ lead forms and search controls with the information that changes the next recommendation.
2. **Treat people as more than a transaction.** The company explicitly distinguishes finding direction from simply finding work. _UI implication:_ pair a task result with relevant career-support routes when product evidence supports them; do not fabricate counseling flows.
3. **Give help with humility and clarity.** “Be A Giver” describes honest feedback delivered with humility and kindness. _UI implication:_ feedback copy should be specific, respectful, and explain what the user can do next.
4. **Build capability, not dependency.** 104’s mission frames knowledge and skill as ways to create opportunity and value. _UI implication:_ make criteria, progress, and available learning/help understandable rather than obscuring them behind a score.
5. **Use technology to improve matching.** The company presents AI and data-supported recommendations as tools for more relevant matches. _UI implication:_ explain the role of inputs and recommendations plainly; never imply a certainty the system cannot substantiate.
