    ...
    heading-3:
      {
        ...
        weight: 600,
        lineHeight: 1.4,
        use: "Card headings, panel titles",
      }
    subtitle:
      {
        size: 18,
        weight: 600,
        lineHeight: 1.45,
        use: "Lead-in / dashboard section labels",
      }
    body-large:
      { size: 16, weight: 400, lineHeight: 1.6, use: "Marketing paragraphs" }
    body:
      {
        size: 14,
        weight: 400,
        lineHeight: 1.55,
        use: "Dashboard standard text",
      }
    body-small:
      {
        size: 13,
        weight: 400,
        lineHeight: 1.5,
        use: "Table cells, secondary info",
      }
    caption:
      {
        size: 12,
    ...
    label-eyebrow:
      {
        ...
        lineHeight: 1.4,
        tracking: 0.06,
        use: "Section eyebrows, table headers, uppercase",
      }
    code-mono:
      {
        size: 13,
        weight: 400,
        lineHeight: 1.6,
        use: "DNS records, IPs, API tokens, code",
      }
  spacing:
    ...
    input:
      {
        ...
        padding: "0 16px",
        font: "14px / 400",
        focus: "1.5px brand ring · 0 0 0 3px rgba(246,130,31,0.2)",
    ...
    stat-card:
      {
        ...
        radius: "8px",
        padding: "20px",
        font: "32px / 700 #1d1f20 number · 12px / 600 uppercase #717174 label",
    ...
    status-pill:
      {
        ...
        padding: "2px 10px",
        font: "12px / 600",
        states: "green active #e8f5d8/#3d6b14 · red down #fbe2e2/#bd2528 · yellow pending #fcf3d6/#8a6d1b · grey #ededed/#4d4d4d · orange #fdf3e7/#c2670f",
    ...
    tabs:
      {
        ...
        border: "1px solid #ededed bottom rule",
        font: "14px / 600",
    ...
    toast:
      {
        ...
        states: "success #2fb344 · error #bd2528 · warning #f6c549 · info #2c7cb0",
...
Cloudflare is the connectivity-cloud company that sits in front of a meaningful slice of the internet — CDN, DNS, DDoS mitigation, Zero Trust, Workers edge compute. Its visual identity has one job: make planet-scale infrastructure feel _approachable and human_ in a category that defaults to cold, blue, enterprise seriousness. The answer is a single, unmistakable move — **Cloudflare Orange (`#F6821F`)** against generous white space and near-black charcoal text. In a backend-devops landscape where AWS, Azure, GCP, Datadog, and nearly every security vendor reach for navy and electric blue, Cloudflare's warm orange is a deliberate act of differentiation. The orange _is_ the brand; everything else is restraint built to let it sing.
...
- One line of `#36393A` body explaining the _why_ + one orange-ghost or secondary action; no dashboard illustration
...
Cloudflare's voice is **technical but human** — confident, plain-spoken, and quietly witty. It explains hard infrastructure to a broad audience (a solo developer on the free plan and a Fortune 100 security team) without dumbing it down or drowning it in jargon. The famous mission line — _"to help build a better Internet"_ — sets the register: ambitious, optimistic, capital-I "Internet." Marketing copy is benefit-led and concrete; the blog (a beloved engineering channel) goes deep with precision and personality. Sentences are direct. Claims are specific and measurable.
...
| Blog / docs       | Deep, candid, occasionally playful; explains the _why_ behind the engineering.                        |
...
_Personas below are fictional archetypes informed by publicly described Cloudflare user segments, not individual people._
