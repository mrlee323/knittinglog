  ...
  claims:
    "tokens.colors.primary":
      &marketing {
        surface_id: home,
        source_id: home-live,
        method: evidence-bundle-live-inspect,
        captured: "2026-07-13",
      }
    ...
    hero:
      {
        ...
        lineHeight: 1.10,
        tracking: -3,
        use: "Current marketing hero heading",
      }
    section:
      {
        size: 48,
        ...
        lineHeight: 1.10,
        tracking: -2,
        use: "Repeated marketing section heading",
      }
    subheading:
      {
        size: 32,
    ...
    body:
      {
        ...
        weight: 400,
        lineHeight: 1.40,
        use: "Repeated marketing body and list text",
      }
    action:
      { size: 14, weight: 500, lineHeight: 1.40, use: "Compact action label" }
    code:
      {
        size: 12,
        weight: 500,
        lineHeight: 1.60,
        use: "Observed code-oriented marketing text",
      }
    ...
    header-primary:
      {
        ...
        height: "36px",
        font: "14px / 500 / Inter",
        states: "hover and pressed observed; pressed background #010101",
    ...
    pricing-action:
      {
        ...
        height: "32px",
        font: "12px / 500 / Inter",
        states: "hover background #010101 and pressed background #030304 observed",
...
1. **Universal application delivery.** Expo’s public product message spans Android, iOS, and web. _UI implication:_ explain cross-platform capability with product evidence, not platform-specific visual invention.
2. **Neutral, reliable foundations.** The official brand manifesto explicitly contrasts Expo’s foundation with more expressive platform design languages. _UI implication:_ prefer the observed quiet light hierarchy over decorative color.
3. **Simple, spacious, consistent presentation.** These are first-party brand-guideline goals. _UI implication:_ retain measured spacing and rounded-action roles; do not manufacture a full grid.
4. **Concrete developer operations.** EAS documentation describes build, submit, update, workflow, hosting, and observability services. _UI implication:_ use concise, task-oriented labels rather than generic benefit copy.
