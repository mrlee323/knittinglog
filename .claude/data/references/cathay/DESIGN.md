    ...
    subheading:
      {
        ...
        lineHeight: 1.50,
        tracking: 0,
        use: "Quick-action labels, lead text",
      }
    body:
      {
        size: 16,
        ...
        lineHeight: 1.50,
        tracking: 0,
        use: "Standard reading text, nav, button label",
      }
    caption:
      {
        size: 14,
        ...
        lineHeight: 1.50,
        tracking: 0,
        use: "Footer links, metadata, fine print",
      }
...
_Personas below are fictional archetypes informed by publicly observable Cathay United Bank customer segments (everyday retail banking customers in Taiwan, CUBE App / CUBE card users, group cross-sell customers), not individual people._
