...
tokens:
  ...
  typography:
    ...
    display-large:
      {
        ...
        lineHeight: 1.20,
        tracking: -0.01,
        use: "Page titles, key statements",
      }
    heading-1:
      {
        size: 32,
    ...
    heading-3:
      {
        ...
        weight: 600,
        lineHeight: 1.40,
        use: "Feature titles, list headers",
      }
    subtitle:
      {
        size: 18,
    ...
    body-large:
      { size: 16, weight: 400, lineHeight: 1.63, use: "Primary reading text" }
  ...
  components:
    ...
    input:
      {
        ...
        padding: "14px 16px",
        font: "16px / 400",
        focus: "2px #141413 border + outer ring",
    ...
    alert:
      {
        type: toast,
        bg: "#F7F7F7",
        border: "4px left semantic color",
        radius: "8px",
        padding: "16px",
    ...
    toggle:
      {
        type: toggle,
        bg: "#CCCCCC track off, #141413 track on",
        radius: "9999px",
...
_Personas below are fictional archetypes informed by publicly described global-payments user segments, not individual people._
