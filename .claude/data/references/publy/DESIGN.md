    ...
    display:
      {
        ...
        lineHeight: 1.33,
        tracking: -0.4,
        use: "Landing hero, report cover title",
      }
    heading-lg:
      {
        size: 24,
    ...
    heading:
      {
        ...
        lineHeight: 1.40,
        tracking: -0.3,
        use: "Sub-section, card group header",
      }
    title:
      {
        size: 16,
    ...
    body-lg:
      {
        ...
        lineHeight: 1.63,
        tracking: -0.2,
        use: "Long-form report body, generous leading",
      }
    body:
      {
        size: 14,
        ...
        lineHeight: 1.57,
        tracking: -0.2,
        use: "Default body, card description",
      }
    label:
      {
        size: 14,
        ...
        lineHeight: 1.43,
        tracking: -0.2,
        use: "Tab label, emphasized inline",
      }
    caption:
      {
        size: 13,
    ...
    button-primary:
      {
        ...
        padding: "12px 16px",
        font: "14px / 600",
        use: "Primary CTA — 멤버십 시작하기, 3일 무료체험",
      }
    button-outline:
      {
        type: button,
        ...
        padding: "12px 16px",
        font: "14px / 600",
        use: "Secondary CTA — 저장하기, 공유하기, 1px #7a3bff border",
      }
    button-neutral:
      {
        type: button,
        ...
        padding: "12px 16px",
        font: "14px / 500",
        use: "Tertiary action, 1px #e2e8f0 border",
      }
    button-ghost:
      {
        type: button,
    ...
    input:
      {
        ...
        padding: "12px 14px",
        font: "14px / 400",
        use: "Default text input, 1px #e2e8f0 border, focus #7a3bff",
      }
    search:
      {
        type: input,
    ...
    content-card:
      {
        ...
        radius: 12,
        padding: "20px",
        use: "Report / content card, 1px #e2e8f0 border",
      }
    membership-card:
      {
        type: card,
        ...
        radius: 12,
        padding: "24px",
        use: "Membership / paywall promotion",
      }
    tag-default:
      {
        type: badge,
    ...
    tab:
      {
        ...
        font: "14px / 600",
        use: "Topic nav",
        active: "#7a3bff text + 2px purple underline",
      }
...
- Note: PUBLY is a _composed mid-radius_ system — nothing sharp (transactional), nothing bubbly (consumer-app). 8-12px is the credible-professional range.
...
1. **The product is reading.** Everything serves sustained reading of credible knowledge. _UI implication:_ long-form body gets a comfortable measure and generous leading; never sacrifice reading comfort for density.
2. **One purple, rarely used.** `#7a3bff` is the only accent and earns emphasis through scarcity. _UI implication:_ if purple appears on more than the forward-moving actions and active states, it has been overused — pull it back.
3. **Hierarchy in slate, not color.** Text rank is built in the slate scale. _UI implication:_ never reach for a colored label to create hierarchy; restate with weight + slate-shade.
4. **Composed flatness over depth.** Default cards carry a 1px slate border, not a shadow. _UI implication:_ shadows are for hover and floating overlays only; the flat-bordered card is the credible-professional default.
5. **Credible, not hype.** The brand sells knowledge as a tool, not a life-hack. _UI implication:_ copy and packaging avoid clickbait and urgency; titles are specific and useful.
6. **Worth paying for.** The design has to justify a membership fee. _UI implication:_ polish, whitespace, and consistency are non-negotiable — a cheap-looking surface undermines the value proposition.

## 13. Personas

_Personas are fictional archetypes informed by PUBLY's publicly described user base (Korean knowledge workers and ambitious professionals investing in career growth), not individual people._
