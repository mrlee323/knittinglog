...
tokens:
  ...
  typography:
    ...
    display-hero:
      {
        ...
        lineHeight: 1.14,
        tracking: -3.49,
        use: "Hero headline, full-bleed over imagery, white on dark",
      }
    section:
      {
        size: 36,
        ...
        lineHeight: 1.40,
        tracking: -1.50,
        use: "Section titles, e.g. solution headlines",
      }
    subheading:
      {
        size: 24,
        ...
        lineHeight: 1.00,
        tracking: -1.00,
        use: "Card / sub-section heads, industry labels",
      }
    body-lg:
      {
        size: 20,
        weight: 500,
        lineHeight: 1.40,
        use: "Intro paragraphs, lead copy",
      }
    body:
      {
        size: 18,
    ...
    button:
      { size: 18, weight: 500, lineHeight: 1.00, use: "Primary button label" }
    caption: { size: 15, weight: 400, use: "Small labels, footer, metadata" }
  spacing:
    { xs: 4, sm: 8, md: 12, base: 16, lg: 24, xl: 30, xxl: 48, section: 80 }
    ...
    card:
      {
        ...
        radius: "8px",
        shadow: "rgba(0,0,0,0.04) 0px 0px 10px 0px",
        hover: "rgba(0,0,0,0.19) 0px 0px 10px 0px",
...
1. **Impact over algorithms.** The brand frames itself as _Data → Intelligence → Impact_. Design artifacts should foreground outcomes and clarity, not technical spectacle.
...
_Personas below are fictional archetypes informed by publicly observable iKala customer segments (APAC enterprise AI buyers, retail/manufacturing digital-transformation leads, brand marketers using influencer intelligence), not individual people._
