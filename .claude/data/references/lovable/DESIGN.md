...
verification_v2:
  ...
  surfaces:
    - {
        ...
        url: "https://lovable.dev/ko",
        inspected: "2026-07-12",
      }
    - {
        id: pricing,
        kind: marketing-pricing,
        url: "https://lovable.dev/ko/pricing",
        inspected: "2026-07-12",
      }
    - {
        id: product-managers,
        kind: marketing-product,
        url: "https://lovable.dev/ko/product-managers",
        inspected: "2026-07-12",
      }
    - {
        id: docs-welcome,
  ...
  sources:
    ...
    - {
        id: product-managers-live,
        kind: product-surface,
        url: "https://lovable.dev/ko/product-managers",
        captured: "2026-07-12",
      }
    - {
        id: docs-welcome-official,
        kind: official-doc,
        url: "https://docs.lovable.dev/introduction/welcome",
        captured: "2026-07-13",
      }
    - {
        id: docs-quick-start-official,
        kind: official-doc,
        url: "https://docs.lovable.dev/introduction/getting-started",
        captured: "2026-07-13",
      }
    - {
        id: camera-font-asset,
        kind: brand-asset,
        url: "https://lovable.dev/fonts/CameraPlainVariable-c48bd243.woff2",
        captured: "2026-07-12",
      }
  conflicts: []
  claims:
    ...
    "tokens.typography.family.ui":
      &font {
        surface_id: home,
        source_id: camera-font-asset,
        method: computed-style+FontFaceSet,
        captured: "2026-07-12",
      }
    ...
    display:
      {
        ...
        lineHeight: 1.1,
        tracking: -1.5,
        use: "Current public display heading",
      }
    section:
      {
        size: 48,
        ...
        lineHeight: 1.1,
        tracking: -1.2,
        use: "Repeated public section heading",
      }
    heading:
      {
        size: 36,
        ...
        lineHeight: 1.1,
        tracking: -0.9,
        use: "Current public feature heading",
      }
    body:
      {
        size: 16,
    ...
    navigation:
      {
        ...
        weight: 400,
        lineHeight: 1.6,
        use: "Top-level public navigation trigger",
      }
    action:
      {
        size: 14,
        weight: 400,
        lineHeight: 1.5,
        use: "Current compact public action",
      }
    ...
    header-nav-trigger:
      {
        ...
        height: "32px",
        font: "15px / 400 / 24px",
        states: 'hover, pressed, and focus captured on home::[data-omd-capture="1"]',
    ...
    header-primary-action:
      {
        ...
        height: "32px",
        font: "14px / 400 / 21px",
        states: "default captured on all three public routes; no role-specific hover, pressed, or focus variant promoted",
    ...
    pricing-cycle-tab:
      {
        type: tab,
        bg: "transparent",
        fg: "lab(42.0087 -0.102207 0.363302)",
        radius: "9999px",
        padding: "0px 12px",
        height: "32px",
        font: "14px / 400 / 21px",
        states: 'hover, pressed, and selected captured on pricing::[data-omd-capture="9"]',
    ...
    pricing-selector:
      {
        ...
        height: "32px",
        font: "14px / 400 / 21px",
        states: 'pressed, focus, and menu-open captured on pricing::[data-omd-capture="12"]',
        use: "Public pricing combobox trigger",
      }
    pricing-info-dialog:
      {
        type: dialog,
        bg: "lab(99.9884 -0.0000298023 0)",
        fg: "lab(0.903296 0 0)",
        radius: "12px",
        padding: "16px",
        font: "16px / 400 / 24px",
        ...
        states: 'dialog-open captured on pricing::[data-omd-interaction-capture="dialog-3-0"]',
