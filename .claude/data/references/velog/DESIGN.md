    ...
    button-login:
      {
        ...
        radius: 16,
        font: "16px/700",
        use: "Dark sign-in pill, top-right header, h32",
      }
    button-write:
      {
        type: button,
        bg: "#12b886",
        fg: "#ffffff",
        use: "Brand teal primary-action — compose a post",
      }
    header:
      {
        type: card,
    ...
    page:
      {
        ...
        fg: "#212529",
        font: "16px",
        use: "Soft-gray reading canvas framing white blocks",
      }
