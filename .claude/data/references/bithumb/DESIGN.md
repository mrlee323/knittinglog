    ...
    body:
      {
        size: 14,
        weight: 400,
        use: "Workhorse readable content in a packed layout",
      }
    control:
      { size: 13, weight: 500, use: "Buttons, chips, interactive labels" }
    micro-label:
      {
        size: 12,
        weight: 400,
        use: "Dense data annotations coexisting with numbers",
      }
    ...
    button-primary:
      {
        ...
        height: "32px",
        font: "13px / 500",
        use: "Signup — structural top-chrome action",
      }
    cta-filled:
      {
        type: button,
        ...
        height: "56px",
        font: "18px / 500",
        use: "Primary exchange CTA — single warmest action",
      }
    cta-outline:
      {
        type: button,
        ...
        radius: "4px",
        height: "56px",
        use: "Secondary action paired with filled bronze CTA",
      }
    chip-active:
      {
        type: badge,
