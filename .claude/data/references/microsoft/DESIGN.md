...
verification_v2:
  ...
  sources:
    ...
    - {
        id: microsoft-365-live,
        kind: product-surface,
        url: "https://www.microsoft.com/en-us/microsoft-365",
        captured: "2026-07-13",
      }
    - {
        id: fluent-typography,
        kind: official-doc,
    ...
    - {
        id: segoue-license,
        kind: license,
        url: "https://learn.microsoft.com/en-us/typography/fonts/font-faq",
        captured: "2026-07-13",
      }
  conflicts: []
  claims:
    ...
    "tokens.colors.primary-dark":
      &m365 {
        surface_id: microsoft-365,
        source_id: microsoft-365-live,
        method: computed-style,
        captured: "2026-07-13",
      }
    ...
    display:
      {
        ...
        lineHeight: 1.17,
        tracking: -1.2,
        use: "Observed home and Microsoft 365 public-marketing headings",
      }
    section:
      {
        size: 32,
        ...
        lineHeight: 1.25,
        tracking: -0.8,
        use: "Observed marketing section headings",
      }
    card-title:
      {
        size: 20,
        ...
        lineHeight: 1.4,
        tracking: -0.5,
        use: "Observed home card headings",
      }
    body:
      {
        size: 16,
        ...
        lineHeight: 1.5,
        tracking: -0.48,
        use: "Observed marketing body copy",
      }
    cta:
      {
        size: 15,
        ...
        lineHeight: 1.47,
        tracking: -0.3,
        use: "Observed marketing action labels",
      }
    ...
    m365-tab-active:
      {
        ...
        active: true,
        use: "Observed active Microsoft 365 pill tab",
      }
---
...
1. **Empower people and organizations.** Microsoft’s stated mission centers the user’s outcome. _UI implication:_ state the user’s task and next action plainly.
2. **Earn trust.** Microsoft names a safe, secure, and responsible digital world as an enduring commitment. _UI implication:_ make consequential states and explanations clear rather than decorative.
3. **Respect platform context.** Fluent uses native platform defaults where appropriate. _UI implication:_ use the relevant platform/Fluent guidance instead of forcing marketing chrome into a product UI.
4. **Use semantic systems.** Fluent documents global and alias token layers. _UI implication:_ choose role-based tokens in a Fluent implementation rather than hard-coding a marketing hex.
