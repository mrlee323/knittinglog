    ...
    discount:
      {
        ...
        weight: 700,
        lineHeight: 1.35,
        use: "Discount price, coupon amount",
      }
    confirm:
      {
        size: 18,
    ...
    button-primary:
      {
        ...
        radius: "8px",
        font: "16px / 600",
        use: "Primary CTA / cart checkout, 50px height",
      }
    button-confirm:
      {
        type: button,
        ...
        radius: "8px",
        font: "18px / 500",
        use: "Full-width drawer-bottom confirm, 56px height",
      }
    button-secondary:
      {
        type: button,
        ...
        radius: "4px",
        font: "14px / 500",
        use: "Dark secondary buy-now inline, 34px height",
      }
    button-outline:
      {
        type: button,
        ...
        radius: "4px",
        font: "14px / 500",
        use: "Outline delete / cancel, 1px #e5e5e5 border, 34px height",
      }
    button-discovery:
      {
        type: button,
        ...
        radius: "6px",
        font: "15px / 600",
        use: "Shorts / discovery CTA, 40px height",
      }
    card-coupon:
      {
        type: card,
        ...
        fg: "#eb2b51",
        font: "27px / 700",
        use: "Active coupon card, rose-red amount",
      }
    nudge-urgency:
      {
        type: toast,
        bg: "rgba(47,23,253,0.05)",
        fg: "#6456dc",
        radius: "4px",
        font: "14px / 500",
        use: "Urgency countdown nudge bar, 38px height",
      }
...
- _"지금 라이브 중! 방송에서만 만나는 특가를 놓치지 마세요."_ — live broadcast nudge copy
- _"그리퍼가 직접 쓰고 추천하는 아이템, 지금 채팅으로 물어보세요."_ — seller trust prompt
- _"1,000만이 선택한 영상 쇼핑, 그립."_ — official slogan from og:title meta tag
...
_Illustrative Gripper (Seller) — "Minjung, 34, Busan"_
...
_Illustrative Buyer / Fan — "Soyeon, 28, Seoul"_
...
_Illustrative Discovery Shopper — "Junho, 41, Daejeon"_
...
_Illustrative B2B Brand Manager — "Hyeji, 30, Seoul"_
