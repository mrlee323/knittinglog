    ...
    display:
      {
        ...
        lineHeight: 1.15,
        tracking: -0.01,
        use: "Marketing hero, sign-up headline",
      }
    heading-lg:
      {
        size: 32,
        weight: 700,
        lineHeight: 1.2,
        use: "Modal title, detail-page show name",
      }
    heading:
      {
        size: 24,
    ...
    row-title:
      {
        ...
        weight: 700,
        lineHeight: 1.3,
        use: "Row headers like Trending Now",
      }
    subtitle:
      {
        size: 18,
        weight: 500,
        lineHeight: 1.4,
        use: "Card title in expanded preview",
      }
    body-lg:
      { size: 16, weight: 400, lineHeight: 1.5, use: "Synopsis, descriptions" }
    body:
      {
        size: 14,
        weight: 400,
        lineHeight: 1.5,
        use: "Standard metadata, list rows",
      }
    caption:
      {
        size: 13,
        weight: 400,
        lineHeight: 1.4,
        use: "Match %, maturity rating, runtime",
      }
    micro:
      {
        size: 12,
        ...
        lineHeight: 1.4,
        tracking: 0.02,
        use: "Legal, fine print, footer links",
      }
  spacing:
    { xs: 4, sm: 8, md: 12, base: 16, lg: 24, xl: 32, xxl: 48, section: 60 }
    ...
    button-primary:
      {
        ...
        padding: "8px 24px",
        font: "16px / 700",
        states: "hover rgba(255,255,255,0.75)",
    ...
    button-secondary:
      {
        ...
        padding: "8px 24px",
        font: "16px / 700",
        states: "hover rgba(109,109,110,0.4)",
    ...
    input-auth:
      {
        ...
        font: "16px / 400",
        focus: "border #FFFFFF",
        states: "error border-bottom 2px #E87C03",
    ...
    tab-nav:
      {
        ...
        fg: "#E5E5E5",
        font: "14px / 400",
        active: "color #FFFFFF weight 700",
        states: "hover #B3B3B3",
        use: "Top nav links",
      }
    toast-banner:
    ...
    toggle-default:
      {
        ...
        bg: "#737373",
        radius: "9999px",
        states: "on track #E50914, thumb #FFFFFF",
...
_Personas below are fictional archetypes informed by publicly described streaming-viewer segments, not individual people._
