...
verification_v2:
  ...
  surfaces:
    ...
    - {
        id: corp-culture,
        kind: marketing,
        url: "https://www.kakaocorp.com/page/about/culture",
        inspected: "2026-07-11",
      }
    - {
        id: corp-milestones,
        kind: marketing,
        url: "https://www.kakaocorp.com/page/about/milestones",
        inspected: "2026-07-11",
      }
    - {
        id: login-guide,
        kind: design-system,
        url: "https://developers.kakao.com/docs/ko/kakaologin/design-guide",
        inspected: "2026-07-11",
      }
  sources:
    - {
    ...
    - {
        id: corp-culture-live,
        kind: product-surface,
        url: "https://www.kakaocorp.com/page/about/culture",
        captured: "2026-07-11",
      }
    - {
        id: corp-milestones-live,
        kind: product-surface,
        url: "https://www.kakaocorp.com/page/about/milestones",
        captured: "2026-07-11",
      }
  ...
  claims:
    "tokens.colors.login":
      &login_doc {
        surface_id: login-guide,
        source_id: login-guide-live,
        method: official-doc-rendered-text,
        captured: "2026-07-11",
      }
    ...
    "tokens.colors.marketing":
      &corp_live {
        surface_id: corp-home,
        source_id: corp-home-live,
    ...
    "tokens.colors.muted":
      &milestones_live {
        surface_id: corp-milestones,
        source_id: corp-milestones-live,
        method: computed-style,
        captured: "2026-07-11",
      }
    ...
    "tokens.colors.border":
      &culture_live {
        surface_id: corp-culture,
        source_id: corp-culture-live,
        method: computed-style,
        captured: "2026-07-11",
      }
...
tokens:
  ...
  typography:
    ...
    body-readable:
      { size: 14, weight: 400, lineHeight: "24.92px", tracking: "-0.2px" }
    caption: { size: 12, weight: 400, lineHeight: "18px", tracking: "-0.2px" }
    login-label: { size: "30Pt" }
  spacing: { xs: 4, sm: 6, md: 8, lg: 16, xl: 20 }
  rounded:
    { login: 12, marketing: 16, search: 18, footer: 24, filter: 30, full: 999 }
    ...
    corporate-nav:
      {
        ...
        states: "light and dark theme variants; focus and hover observed",
