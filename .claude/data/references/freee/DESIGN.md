...
verification_v2:
  ...
  surfaces:
    ...
    - {
        id: pricing,
        kind: public-marketing,
        url: "https://www.freee.co.jp/pricing/",
        inspected: "2026-07-12",
      }
    - {
        id: products,
        kind: public-marketing,
        url: "https://www.freee.co.jp/products/",
        inspected: "2026-07-12",
      }
  sources:
    - {
    ...
    - {
        id: mission,
        kind: official-doc,
        url: "https://corp.freee.co.jp/mission/",
        captured: "2026-07-13",
      }
    - {
        id: company,
    ...
    body:
      {
        ...
        weight: 400,
        lineHeight: 1.5,
        use: "Observed public-site body text.",
      }
    action:
      {
        size: 16,
        weight: 700,
        lineHeight: 1.5,
        use: "Observed public primary and outline action.",
      }
    heading:
      {
        size: 40,
        weight: 700,
        lineHeight: 1.5,
        use: "Observed public-site heading.",
      }
    ...
    header-primary:
      {
        ...
        hover: "#2761e8",
        use: "Public header sign-up action only.",
      }
    primary-action:
      {
        type: button,
        ...
        hover: "#2863ee",
        use: "Public pricing-page primary action only.",
      }
    segment-card:
      {
        type: card,
        bg: "#ebf3ff",
        radius: "8px",
        use: "Public home segment-selection card only.",
      }
---
...
1. **Support small-business autonomy.** _UI implication:_ make the relevant management outcome explicit before the call to action.
2. **Separate evidence domains.** _UI implication:_ public marketing, authenticated product, documentation chrome, and historical Vibes assets must not donate tokens to one another without direct evidence.
3. **Treat accessibility as engineering practice.** _UI implication:_ use the official Vibes/a11y context for intent, but verify each public UI value at the actual surface before implementation.
