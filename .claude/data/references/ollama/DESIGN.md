...
verification_v2:
  ...
  claims:
    ...
    "tokens.typography.body-sm.weight":
      {
        surface_id: home,
        source_id: home-live,
        method: computed-style,
    ...
    "tokens.typography.body-sm.lineHeight":
      {
        surface_id: home,
        source_id: home-live,
        method: computed-style,
    ...
    "tokens.typography.nav.lineHeight":
      {
        surface_id: home,
        source_id: home-live,
        method: computed-style,
    ...
    body-sm:
      {
        ...
        weight: 400,
        lineHeight: 1.43,
        use: "Observed product text and input",
      }
    body:
      {
        size: 16,
        weight: 400,
        lineHeight: 1.5,
        use: "Observed product list and body text",
      }
    nav:
      {
        size: 18,
        weight: 400,
        lineHeight: 1.56,
        use: "Product navigation and header controls",
      }
    section:
      {
        size: 30,
...
1. **Open models should be practical to run.**
   _UI implication:_ make installation, model selection, and API entry points easy to scan.
2. **Ownership and privacy remain legible.**
   _UI implication:_ explain the local path plainly and avoid making cloud the only visible route.
3. **Scale is an extension, not a replacement.**
   _UI implication:_ distinguish local capability from optional cloud capacity in layout and copy.
4. **Developer actions come before persuasion.**
   _UI implication:_ use commands, integrations, and links as primary content.
