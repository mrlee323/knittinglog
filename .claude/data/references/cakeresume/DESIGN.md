    ...
    button-primary:
      {
        ...
        height: "32px",
        font: "14px / 400",
        use: "Single most important action (Sign Up, primary submit)",
      }
    button-secondary:
      {
        type: button,
        ...
        height: "32px",
        font: "14px / 400",
        use: "Quieter Log In beside primary",
      }
    language-selector:
      {
        type: input,
        ...
        height: "32px",
        font: "14px / 400",
        use: "Header locale/language switcher",
      }
    chip-neutral:
      {
        type: badge,
        ...
        border: "none",
        radius: "4px",
        use: "Receding metadata/tag pills",
      }
---
