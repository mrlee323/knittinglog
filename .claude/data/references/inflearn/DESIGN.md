...
verification_v2:
  ...
  sources:
    ...
    - {
        id: company-context,
        kind: official-doc,
        url: "https://story.inflab.com/main/%ED%9A%8C%EC%82%AC%EC%86%8C%EA%B0%9C/",
        captured: "2026-07-13",
      }
    - {
        id: font-design,
    ...
    product-body:
      {
        ...
        weight: 400,
        lineHeight: 1.50,
        use: "Repeated product-home and course-catalog text/card sample",
      }
    product-control:
      {
        size: 16,
        weight: 400,
        lineHeight: 1.00,
        use: "Product GNB and control sample",
      }
    course-badge:
      {
        size: 11,
        weight: 700,
        lineHeight: 1.64,
        use: "Course badge wrapper on product home and catalog",
      }
    ...
    product-search-submit:
      {
        ...
        states: "hover observed: #00a760",
        use: "Product GNB search submit; home::[data-omd-capture=8]",
      }
    product-nav-action:
      {
        type: button,
        ...
        states: "hover observed: rgba(241,243,245,0.65)",
    ...
    product-course-card:
      {
        ...
        radius: "8px",
        font: "16px / 400 Pretendard",
        states: "default only; no card interaction state captured",
        use: "Product course article shell; home::article",
      }
    product-content-tab:
      {
        type: tab,
        ...
        use: "Product-home selected content tab; home::[data-omd-capture=19]",
      }
    product-dialog-overlay:
      {
        ...
        use: "Product dialog backdrop; home::[data-omd-interaction-capture=dialog-2-8]",
      }
...
1. **Career learning and knowledge sharing.** The company describes a platform for people to learn and share expertise. _UI implication:_ do not replace that service context with unsupported commerce or credential claims.
2. **Transparent information.** The company says it publishes learner counts and course evaluations without selection or manipulation. _UI implication:_ where such data is presented, distinguish actual product evidence from marketing interpretation.
3. **Opportunity through accessibility.** The company describes reducing economic and time barriers to learning. _UI implication:_ do not turn that narrative into unobserved pricing, promotion, or eligibility UI.
