    ...
    hero:
      {
        ...
        weight: 500,
        lineHeight: 1.1,
        use: "Nunito rounded display hero",
      }
    ...
    button-primary:
      {
        ...
        padding: "16px 32px",
        font: "16px / 500",
        use: "Primary download CTA pill, 56px height",
      }
    button-secondary:
      {
        type: button,
        ...
        padding: "16px 32px",
        font: "16px / 500",
        use: "Secondary demo pill, 56px height",
      }
    button-premium:
      {
        type: button,
        ...
        padding: "16px 32px",
        font: "16px / 400",
        use: "Premium / upgrade action on light-green surface, 57px height",
      }
