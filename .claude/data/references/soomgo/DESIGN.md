    ...
    section:
      {
        ...
        lineHeight: 1.33,
        tracking: 0,
        use: "Section headline, page title",
      }
    subheading:
      {
        size: 18,
        weight: 700,
        lineHeight: 1.44,
        use: "Card title, sub-section head",
      }
    title:
      {
        size: 16,
        weight: 700,
        lineHeight: 1.50,
        use: "List item title, h2 default",
      }
    body:
      {
        size: 16,
        weight: 400,
        lineHeight: 1.50,
        use: "Standard reading text, links",
      }
    label:
      {
        size: 14,
        weight: 500,
        lineHeight: 1.43,
        use: "Button label, nav label, chips",
      }
    caption:
      {
        size: 13,
        weight: 400,
        lineHeight: 1.54,
        use: "Metadata, helper text, prices",
      }
  spacing:
    ...
    category-tab:
      {
        ...
        padding: "8px 12px",
        font: "16px / 400",
        active: "Filled dark pill #293341, inactive surface #f6f7f9",
...
_Fictional archetypes informed by Soomgo's publicly observable user segments (homeowners seeking services, and independent pros), not real individuals._
