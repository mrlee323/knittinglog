...
tokens:
  ...
  typography:
    ...
    hero:
      {
        ...
        lineHeight: 0.95,
        tracking: "-0.01em",
        use: "Hero headline, UPPERCASE condensed",
      }
    display-lg:
      {
        size: 48,
        ...
        lineHeight: 1.0,
        tracking: "-0.01em",
        use: "Section banners (JUST IN)",
      }
    display-md:
      { size: 36, weight: 700, lineHeight: 1.05, use: "Editorial sub-headers" }
    h1: { size: 28, weight: 700, lineHeight: 1.2, use: "Product title (PDP)" }
    h2:
      { size: 24, weight: 500, lineHeight: 1.25, use: "Card / section titles" }
    subtitle:
      {
        size: 20,
        weight: 400,
        lineHeight: 1.4,
        use: "Product category, list headers",
      }
    body-lg:
      {
        size: 16,
    ...
    body:
      { size: 15, weight: 400, lineHeight: 1.5, use: "Standard reading text" }
    price:
      {
        size: 16,
        weight: 500,
        lineHeight: 1.4,
        use: "Price; sale price in red",
      }
    caption:
      { size: 13, weight: 400, lineHeight: 1.4, use: "Metadata, color count" }
    label:
      {
        size: 13,
        weight: 700,
    ...
    filter-chip:
      {
        ...
        font: "15px/400",
        use: "PLP filter row",
        active: "filled #111111 bg, #ffffff text",
      }
    toast:
      {
        type: toast,
...
- **Brand Wordmark**: _Futura ND Nike 365_ (custom Futura Bold Condensed) — logo and tier-1 marketing only.
...
_Personas below are fictional archetypes informed by publicly described athletic-retail segments, not individual people._
