    ...
    feature-title:
      {
        ...
        lineHeight: 1.23,
        tracking: 0,
        use: "Editorial / feature card titles on hero carousels",
      }
    section-title:
      {
        size: 22,
        ...
        lineHeight: 1.23,
        tracking: 0,
        use: "Secondary headlines, section heads",
      }
    price-lg:
      {
        size: 24,
        ...
        lineHeight: 1.2,
        tracking: 0,
        use: "Hero / featured product price",
      }
    price:
      {
        size: 18,
        ...
        lineHeight: 1.3,
        tracking: 0,
        use: "Product card price in red #ea1717",
      }
    body:
      {
        size: 16,
        ...
        lineHeight: 1.5,
        tracking: 0,
        use: "Standard reading text, product titles",
      }
    label:
      {
        size: 14,
        ...
        lineHeight: 1.4,
        tracking: 0,
        use: "Tab labels, metadata, secondary nav",
      }
    caption:
      {
        size: 13,
        ...
        lineHeight: 1.4,
        tracking: 0,
        use: "Fine print, spec rows, timestamps",
      }
  spacing:
...
_Personas below are fictional archetypes informed by publicly observable PChome user segments (Taiwanese deal-hunting shoppers, 3C enthusiasts, household buyers, loyalty members), not individual people._
