    ...
    body:
      {
        ...
        weight: 400,
        lineHeight: 1.5,
        use: "Standard reading text, inputs",
      }
...
What HP refuses: the cold institutional gray of legacy enterprise IT, the neon maximalism of gaming-first rivals (HP's OMEN sub-brand carries that energy separately), and decorative ornament that competes with product photography. HP's restraint _is_ its statement — a brand confident enough to let a laptop on white speak for itself.
...
_Personas below are fictional archetypes informed by publicly described consumer-tech buyer segments, not individual people._
