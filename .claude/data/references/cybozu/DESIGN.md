...
tokens:
  ...
  typography:
    family:
      {
        corporate: "Hiragino Kaku Gothic Pro",
        product: "Roboto / Noto Sans JP",
        fallback: "Meiryo",
      }
    corp-body:
      {
        ...
        weight: 400,
        lineHeight: 2.0,
        use: "Corporate body text, Hiragino, 32px line-height",
      }
    corp-nav:
      { size: 14, weight: 700, use: "Corporate nav links, bold Hiragino" }
    corp-en-label:
      {
        size: 16,
        weight: 400,
        use: "English section labels in muted grey #aaaaaa",
      }
    kintone-h2:
      {
        size: 52,
        ...
        lineHeight: 1.45,
        tracking: 2.6,
        use: "kintone section heads, Roboto + Noto Sans JP, positive tracking",
      }
    kintone-h2-alt:
      {
        size: 48,
    ...
    kintone-body:
      {
        ...
        weight: 400,
        lineHeight: 1.69,
        use: "kintone body text, 27px line-height",
      }
    chip: { size: 12, weight: 700, use: "kintone yellow badge chips" }
  spacing:
    { xs: 4, sm: 8, md: 12, base: 16, lg: 20, xl: 24, xxl: 32, section: 62 }
    ...
    corp-nav-link:
      {
        ...
        active: "teal #139cb7 text on hover/active",
    ...
    corp-text-link:
      {
        ...
        use: "Corporate inline / list text link — the single teal action color",
      }
    corp-icon-button:
      {
        type: button,
        ...
        fg: "#139cb7",
        radius: "9999px",
        shadow: "rgba(0,0,0,0.1) 0 0 6px",
        use: "Circular icon button, soft shadow, 40px",
      }
    corp-card:
      {
        type: card,
        ...
        use: "Corporate content card, hairline-separated on #f6f6f6 surface",
      }
    kintone-cta-dark:
      {
        type: button,
        ...
        use: "kintone primary CTA (30日間無料お試し) — dark fill with yellow accent",
      }
    kintone-outline-button:
      {
        type: button,
        bg: "#ffffff",
        fg: "#231200",
        ...
        padding: "5px 5px 5px 20px",
        height: "66px",
        use: "kintone secondary outlined button",
      }
    kintone-card:
      {
        type: card,
        ...
        radius: "10px",
        padding: "24px",
        use: "kintone feature card, flat (no shadow)",
      }
    kintone-badge:
      {
        type: badge,
        ...
        font: "12px / 700",
        use: "kintone yellow tab/banner chip (さわってみよう！, 30日間無料！)",
      }
...
- **Positive tracking as friendliness**: kintone's headlines use _positive_ letter-spacing (`+2.6px` at 52px) — the opposite of tight Western SaaS tracking — to feel open and unintimidating.
...
- Use tight negative tracking on kintone headlines — kintone tracks _positive_ for friendliness
...
3. kintone headlines track _positive_ (+2.6px), weight 700 — approachable, not tight
...
- "サイボウズ株式会社" — corporate page title (institutional register). _(verified live 2026-06-17)_
- "kintone（キントーン） | みんな、つくれる。業務アプリがつくれるサイボウズのノーコード・ローコードツール" — kintone page title (democratizing promise). _(verified live 2026-06-17)_
- "30日間無料お試し" / "個人情報不要！" — kintone trial CTAs (low-pressure, concrete). _(verified live 2026-06-17)_
...
1. **Teamwork is the product.** Cybozu's stated mission is a society overflowing with teamwork; software is the means. _UI implication:_ favor clarity and collaboration cues over feature density; the interface should never feel like a competition.
2. **Everyone can build.** kintone's "みんな、つくれる" democratizes app-building beyond engineers. _UI implication:_ decode jargon into friendly tools; positive headline tracking and warm yellow make the product feel inviting, not technical.
3. **Two voices, one philosophy.** A civic corporate teal and a warm product yellow are kept distinct. _UI implication:_ never mix the teal and yellow systems on one surface — each carries its own register.
4. **Flat and human.** Near-shadowless, hairline-separated layouts keep B2B software approachable. _UI implication:_ separate with tint and hairlines; reserve shadow for the smallest interactive accents.
5. **Design in the open.** The kintone Design System and Product Design Magazine make the practice transparent. _UI implication:_ components are documented, reusable, and consistent — the system is a shared, published artifact, not tribal knowledge.

## 13. Personas

_Personas below are fictional archetypes informed by publicly observable Cybozu / kintone user segments (Japanese SMB operations staff, non-engineer "citizen developers", enterprise IT, and Cybozu's own product designers), not individual people._
