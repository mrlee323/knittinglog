...
verification_v2:
  ...
  surfaces:
    ...
    - {
        id: brand-assets,
        kind: brand-assets,
        url: "https://www.sakura.ad.jp/brand-assets/",
        inspected: "2026-07-13",
      }
  sources:
    - {
    ...
    - {
        id: brand-design,
        kind: brand-asset,
        url: "https://www.sakura.ad.jp/corporate/corp/design/",
        captured: "2026-07-13",
      }
  conflicts: []
  claims:
    ...
    "tokens.typography.family.brand":
      &brand_assets {
        ...
        source_id: brand-assets-live,
        method: supplied-computed-style-and-brand-asset,
        captured: "2026-07-13",
      }
    ...
    body:
      {
        ...
        weight: 400,
        lineHeight: "28px",
        use: "Dominant public corporate body and service-card text.",
      }
    section-title:
      {
        size: 28,
        weight: 600,
        lineHeight: "36.4px",
        use: "Observed public corporate section heading.",
      }
    tab:
      {
        size: 16,
        weight: 400,
        lineHeight: "28px",
        use: "Observed case-study tab label.",
      }
    ...
    service-initiative-list:
      {
        ...
        use: "Static service-initiative list container, selector home::div.service-card.service-initiative-list.",
      }
    case-tab-selected:
      {
        type: tab,
        ...
        height: "110px",
        font: "16px / 400 Noto Sans JP",
        states: "selected and tab-selected observed in supplied tab interaction captures; no other state value is promoted",
        use: "Selected case-study tab, selector home::[data-omd-capture=23].",
      }
---
...
1. **Make ambition actionable.**
   _UI implication:_ name the user’s intended outcome before presenting infrastructure choices.
2. **Keep the technical foundation legible.**
   _UI implication:_ use direct hierarchy, clear data labels, and distinct structural groups rather than opaque decorative layers.
3. **Let human character coexist with precision.**
   _UI implication:_ reserve the official Haru TP expression for branded moments and retain readable Noto Sans JP for dense public UI.
4. **Build with a broader ecosystem in mind.**
   _UI implication:_ write handoffs and service relationships plainly; do not imply that one screen contains every solution.
