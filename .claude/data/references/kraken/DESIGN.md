...
tokens:
    ...
    display-hero:
      {
        ...
        lineHeight: 1.17,
        tracking: "-1px",
        use: "Hero headline, Kraken-Brand",
      }
    section-heading:
      {
        size: 36,
        ...
        lineHeight: 1.22,
        tracking: "-0.5px",
        use: "Section heading, Kraken-Brand",
      }
    sub-heading:
      {
        size: 28,
    ...
    feature-title:
      {
        ...
        weight: 600,
        lineHeight: 1.2,
        use: "Feature title, Kraken-Product",
      }
  ...
  components:
    ...
    card-featured:
      {
        type: card,
        bg: "linear-gradient(135deg, #7132f5 0%, #5741d8 100%)",
        fg: "#ffffff",
        radius: "16px",
        padding: "32px",
...
- Tagline: _"Own the Power of Your Money — Crypto, Stocks & more"_ <!-- verified: kraken.com homepage 2026-05 -->
...
1. **Track record is the proof.** _UI implication:_ footer / About pages reference 2011 founding + survived-events list.
2. **Security before speed.** Two-factor auth, withdrawal whitelisting, hardware key support — first-class. _UI implication:_ security settings have main-nav placement.
3. **Purple is the signal.** `#7132f5` for primary; never multi-color brand chrome. _UI implication:_ charts may use semantic colors but UI stays purple-on-white.
4. **Education = product.** Kraken Learn academy treated as core feature. _UI implication:_ "Learn" tab adjacent to "Trade" in main nav.
5. **Borderless purple buttons signal interactive.** _UI implication:_ primary CTAs always purple `#7132f5` on white, light purple `rgba(133,91,251,0.16)` for ghost variants.

## 13. Personas

_Personas are fictional archetypes informed by Kraken user segments (long-term holders, professional traders, institutional clients), not individual people._
