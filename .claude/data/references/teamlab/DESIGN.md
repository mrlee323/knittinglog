...
verification_v2:
  ...
  surfaces:
    ...
    - {
        ...
        url: "https://www.team-lab.com/product/?category=all",
        inspected: "2026-07-13",
      }
    - {
        id: surface-3,
        kind: public-corporate,
  ...
  sources:
    ...
    - {
        id: company-about,
        kind: official-doc,
        url: "https://www.team-lab.com/en/about/",
        captured: "2026-07-13",
      }
    - {
        id: careers,
        kind: official-doc,
        url: "https://www.team-lab.com/en/recruit/tsunen/",
        captured: "2026-07-13",
      }
    - {
        id: borderless-2024,
        kind: brand-asset,
        url: "https://architects.team-lab.com/projects/teamLab_borderless/",
        captured: "2026-07-13",
      }
    - {
        id: adobe-webfont-license,
        kind: license,
        url: "https://helpx.adobe.com/fonts/using/webfont-licensing.html",
        captured: "2026-07-13",
      }
  conflicts: []
  claims:
    ...
    "tokens.components.product-catalog-card.type":
      &catalog_card {
        surface_id: surface-2,
        source_id: catalog-live,
        method: computed-style,
    ...
    body:
      {
        ...
        weight: 400,
        lineHeight: 22.1,
        use: "Observed public home body and card text metrics",
      }
    nav-label:
      {
        size: 12,
        ...
        lineHeight: 20.4,
        tracking: 0.6,
        use: "Observed public home header-link metrics",
      }
  spacing:
    catalog-gap: 40
    news-inset: 30
    ...
    product-catalog-card:
      {
        ...
        height: "400px",
        font: "13px / 400",
        use: "Public product-catalog link card; surface-2::[data-omd-capture=20]",
      }
---
...
1. **Cross disciplines without collapsing them.** _UI implication:_ keep art, product, corporate, and documentation evidence domains explicit rather than blending their values into one invented interface.
2. **Make the experience larger than the chrome.** _UI implication:_ public informational surfaces can stay visually quiet so imagery and content carry the experiential register.
3. **Value specialized collaboration.** _UI implication:_ organize complex information with clear secondary hierarchy instead of applying decorative emphasis everywhere.
4. **Let exploration remain legible.** _UI implication:_ use measured metadata contrast and spacing for scanning, but do not fabricate interaction behavior for exploratory flows.
