...
tokens:
  ...
  typography:
    ...
    display-hero:
      {
        ...
        lineHeight: 1.14,
        tracking: -0.02,
        use: "Marketing hero headlines (Larsseit)",
      }
    display-lg:
      {
        size: 44,
    ...
    heading-3:
      {
        ...
        weight: 700,
        lineHeight: 1.44,
        use: "Card titles, channel headers",
      }
    subtitle:
      {
        size: 16,
        weight: 700,
        lineHeight: 1.50,
        use: "List headers, emphasized labels",
      }
    body-lg:
      {
        size: 16,
    ...
    body:
      {
        ...
        weight: 400,
        lineHeight: 1.46,
        use: "Message text — the workhorse",
      }
    body-sm:
      {
        size: 13,
    ...
    caption:
      { size: 12, weight: 400, lineHeight: 1.33, use: "Timestamps, fine print" }
    code:
      {
        size: 12,
        weight: 400,
        lineHeight: 1.50,
        use: "Inline code, code blocks (Monaco)",
      }
    ...
    input:
      {
        ...
        padding: "11px 12px",
        font: "15px / 400",
        focus: "border #1264A3 + 0 0 0 1px #1264A3",
    ...
    composer:
      {
        ...
        padding: "8px 12px",
        font: "15px / 400",
        focus: "border rgba(29,28,29,0.5), inner shadow",
    ...
    tab-segmented:
      {
        ...
        bg: "transparent",
        fg: "#616061",
        active: "text #1D1C1D, 2px bottom border #4A154B",
        font: "15px / 700",
...
_Personas below are fictional archetypes informed by publicly described Slack user segments, not individual people._
