...
verification_v2:
  ...
  claims:
    ...
    "tokens.typography.about-display.size":
      &about {
        surface_id: about,
    ...
    about-display:
      {
        ...
        weight: 600,
        lineHeight: 1.00,
        use: "About-page relationship statement",
      }
    about-display-inverse:
      {
        size: 80,
        weight: 600,
        lineHeight: 1.20,
        use: "Dark About-page statement",
      }
    body-emphasis:
      {
        size: 17,
        weight: 600,
        lineHeight: 1.55,
        use: "About-page explanatory copy",
      }
    navigation:
      {
        size: 14,
        weight: 700,
        lineHeight: 1.00,
        use: "Global navigation controls",
      }
